...
class Renter_Screen_4 extends StatelessWidget {
  const Renter_Screen_4({super.key});
  @override
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Image(
                      height: height * 0.2,
                      image: const AssetImage('assets/images/image_4.png')),
                  const Spacer(),
                  const Text('We direct to your payment getaway!',
                      style: AppTexts.HeadingStyle1,
                      textAlign: TextAlign.center),
                  SizedBox(
                    height: height * 0.015,
                  ),
                  const Text('We are waiting for you to complete the payment',
                      style: TextStyle(
                          fontSize: 18,
